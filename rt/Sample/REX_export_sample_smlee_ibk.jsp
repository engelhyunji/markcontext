...
<%
	...
	OOFFile file = oof.addFile("crf.root", "%root%/crf/CLIPtoDRM_smlee_ibk.crf");
	...
	if(strPdfDataType.equals("0")){
		strRtDataPath 		= "/home/tomcat/webapps/module/EPS/rt/SampleREX_1Page.dat";   //data 파일경로
		strPdfFilePath 		= "/home/tomcat/webapps/module/EPS/rt/SampleREX_1Page.pdf";   //pdf 파일경로
