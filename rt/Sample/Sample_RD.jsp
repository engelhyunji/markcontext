...
<%
	...
	String samplePath = "/home/tomcat/webapps/module/EPS/rt/Sample/";
	//String responseStr = "0|" + samplePath + "RD_NIIED_TEST_2page_NoneBarcode.pdf|" + samplePath + "RD_NIIED_TEST_2page_NoneBarcode.pdf.mml|0|15|2|10|274.8|838|264|165.2|274.8";
	String responseStr = "0|" + samplePath + "RD_1page_sample.pdf|" + samplePath + "RD_1page_sample.mml|0|300|110|30|260|528|260|5|260"; //300,110
	...
	String barcodeRow = (request.getParameter("barcodeRow") != null && !request.getParameter("barcodeRow").isEmpty()) ? request.getParameter("barcodeRow") : "120";
	...
	int    	ivCellBlockCount 		= 0; //0
	int 	ivCellBlockRow 			= 0; //0
