...
<%
	...
	String	strPdfDataType = "0";		  //가로세로여부 0-Portrait(세로),1-Landscape(가로) 
	//String	strPrintOptions	= request.getParameter("strPrintOptions");
	String	strPrintOptions	= (request.getParameter("strPrintOptions") != null && !request.getParameter("strPrintOptions").isEmpty()) ? request.getParameter("strPrintOptions") : "0";
	// cjkang 20190403 추가 민원용
	//String strBrokerOptions = request.getParameter("strBrokerOptions");
	String	strBrokerOptions	= (request.getParameter("strBrokerOptions") != null && !request.getParameter("strBrokerOptions").isEmpty()) ? request.getParameter("strBrokerOptions") : "2";
	// 20240321_hwanghw: 바코드 값 입력 테스트
	//String barcodeCount = request.getParameter("barcodeCount");
	String	barcodeCount	= (request.getParameter("barcodeCount") != null && !request.getParameter("barcodeCount").isEmpty()) ? request.getParameter("barcodeCount") : "300";
	//String barcodeRow = request.getParameter("barcodeRow");
	String	barcodeRow	= (request.getParameter("barcodeRow") != null && !request.getParameter("barcodeRow").isEmpty()) ? request.getParameter("barcodeRow") : "100";
	...
	if(strPdfDataType.equals("0")){
		strRtDataPath 		= "/tomcat/apache-tomcat-10.1.25/webapps/ROOT/rt/Sample/oz_markany_78ae11ff-81f0-4748-8d44-15ba96c6ef3b.dat";   //data 파일경로
		strPdfFilePath 		= "/tomcat/apache-tomcat-10.1.25/webapps/ROOT/rt/Sample/oz_markany_78ae11ff-81f0-4748-8d44-15ba96c6ef3b.pdf";   //pdf 파일경로
		
		
		
	}else{
		strRtDataPath 		= "/home/tomcat/webapps/module/EPS/rt/Sample/OZ_REX_garo_2page.dat";   //data 파일경로
		strPdfFilePath 		= "/home/tomcat/webapps/module/EPS/rt/Sample/OZ_REX_garo_2page.pdf";   //pdf 파일경로
...
<html>
	...
	<body onLoad="init();">
	  ...
	  <input type="hidden" name ="BrokerOptions" value="<%=strBrokerOptions%>">
 	  ...
 	  <!-- 20240321_hwanghw: 바코드 값 입력 테스트-->
	  <input type="hidden" name ="Barcodecount" value="<%=barcodeCount%>">
	  <input type="hidden" name ="BarcodeRow" value="<%=barcodeRow%>">
	  </form>  	  	  	  
	</body>
</html>
