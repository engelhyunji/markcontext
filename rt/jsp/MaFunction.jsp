...
<%!public static String replaceAll(String dest, String src, String rep) {
	...
	// --- 보조 함수: 현재 세션 ID를 가진 쿠키의 이름을 찾는 로직 ---
public static String getSessNameFromValue(Cookie[] cookies, String value) {
		for (Cookie c : cookies) {
			if (value.equals(c.getValue())) return c.getName();
		}
		return "JSESSIONID"; // 기본값
	}
%>
